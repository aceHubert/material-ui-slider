      ...
      <div className={classes.container}>
        <header className={classes.header}>  
          ...
          <div className={classes.titleContainer}>
            ...
            <Button variant="contained" size="small" className={classes.button} href="https://github.com/aceHubert/material-ui-slider">
            ...
            <Button color="primary" variant="contained" size="small" className={classes.button} href="#getting_started">
              Document
            </Button>
          </div>
              ...
              <div className={classes.details}>
                ...
                <div className={classes.controls}>
                  ...
                  <Hidden smDown>  
                    ...
                    <Slider className={classes.volumn} onChangeComplete={this.handleVolumn}></Slider>            
                  </Hidden>
                </div>
              </div>
            </Card>
